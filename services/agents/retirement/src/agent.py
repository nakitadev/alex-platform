...
def get_model(force_openrouter: bool = False) -> LitellmModel:
    ...
    if use_openrouter and openrouter_api_key:
        ...
        logger.info(f"Retirement: Using OpenRouter model {openrouter_model}")
...
def create_agent(job_id: str, portfolio_data: Dict[str, Any], user_preferences: Dict[str, Any], db, force_openrouter: bool = False):
    """Create the retirement specialist agent."""

    model = get_model(force_openrouter=force_openrouter)
