...
def get_model(force_openrouter: bool = False) -> LitellmModel:
    ...
    if use_openrouter and openrouter_api_key:
        ...
        logger.info(f"Reporter: Using OpenRouter model {openrouter_model}")
...
def create_agent(job_id: str, portfolio_data: Dict[str, Any], user_data: Dict[str, Any], db=None, force_openrouter: bool = False):
