...
def get_model(force_openrouter: bool = False) -> LitellmModel:
    ...
    if use_openrouter and openrouter_api_key:
        ...
        logger.info(f"Planner: Using OpenRouter model {openrouter_model}")
...
def create_agent(job_id: str, portfolio_summary: Dict[str, Any], db, force_openrouter: bool = False):
